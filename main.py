...
#############################Function buttons ###################
    ...
    def open_img(self):
        try:
            ...
            messagebox.showerror("Error", f"Failed to open Image Library: {str(e)}", parent=self.root)
    ...
    def attendance_data(self):
        try:
            ...
            messagebox.showerror("Error", f"Failed to open Attendance: {str(e)}", parent=self.root)
    ...
    def developer_data(self):
        try:
            ...
            messagebox.showerror("Error", f"Failed to open Developer info: {str(e)}", parent=self.root)
    ...
    def help_data(self):
        try:
            ...
            messagebox.showerror("Error", f"Failed to open Help Desk: {str(e)}", parent=self.root)

    def isExit(self):
        try:
            iExit=messagebox.askyesno("Face recognition system","Are you sure want to exit?", parent=self.root)
            if iExit>0:
                self.root.destroy()
            else:
                return
        except Exception as e:
            messagebox.showerror("Error", f"Failed to exit: {str(e)}", parent=self.root)
